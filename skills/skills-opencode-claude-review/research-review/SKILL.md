...
description: "Get a deep critical review of research via Claude review via `claude-review` MCP. Use when user says \"review my research\", \"help me review\", \"get external review\", or wants critical feedback on research ideas, papers, or experimental results."
---
...
# Research Review via Claude review via `claude-review` MCP (xhigh reasoning)
...
- This adaptation assumes a `claude-review` MCP bridge that can start and continue review threads.
