...
description: "Get a deep critical review of research from GPT via OpenCode review transport. Use when user says \"review my research\", \"help me review\", \"get external review\", or wants critical feedback on research ideas, papers, or experimental results."
---

# Research Review via OpenCode review transport (xhigh reasoning)
...
- **OpenCode review transport Server** configured in OpenCode:
  ```bash
