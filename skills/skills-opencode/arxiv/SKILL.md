...
```text
skill tool → `research-lit` with arguments: "topic"     - multi-source review: Zotero + Obsidian + local PDFs + web
skill tool → `novelty-check` with arguments: "idea"     - verify your idea is novel against these papers
```
