...
description: "Autonomous multi-round research review loop. Repeatedly reviews via OpenCode review transport, implements fixes, and re-reviews until positive assessment or max rounds reached. Use when user says \"auto review loop\", \"review until it passes\", or wants autonomous iterative improvement."
---
...
- REVIEWER_MODEL = `gpt-5.4` — Model used via OpenCode review transport. Must be an OpenAI model (e.g., `gpt-5.4`, `o3`, `gpt-4o`)
